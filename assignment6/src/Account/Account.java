...
public class Account{
    ...
    public double DebitTransaction(double debitAmount)
    {
       ...
       // System.out.println("You withdrew $"+debitAmount+". You current balance is $"+this.CurBalance+".");
    ...
    public double CreditTransaction(double creditAmount)
    {
       ...
       // System.out.println("You add $"+creditAmount+". You current balance is $"+this.CurBalance+".");
        return this.CurBalance;
    }
